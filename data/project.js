...
var projects = [
		{
			...
			projectWebsite:"https://tianshaoning.github.io/QQbrowser/",
		    startTime:"2016.04",
			endTime:"2016.06",
		...
		},
		{
			...
			projectWebsite:"https://tianshaoning.github.io/phone/",
		    startTime:"2016.04",
			endTime:"2016.06",
		...
		{
			projectName:"music",
			projectWebsite:"https://tianshaoning.github.io/music/",
		    startTime:"2016.06",
			endTime:"至今",
			projectExplain:"作品介绍：网页的交互效果非常好，主要运用原生js 配合css3开发完成，鼠标移入移出动态效果吸引眼球，点击调用指定data中的json数据跳转页面，利用原生js实现全选 删除 暂停播放 调整进度等一系列功能，封装的方法全部原生js实现 ",
			projectLabel:["html","css3","css","js"],
			projectThumbnail:"images/icon/project-4.png"
		},
		{
			projectName:"DESIGNEAT - 视觉类",
			projectWebsite:"https://tianshaoning.github.io/designeat/",
		    startTime:"2016.06",
			endTime:"至今",
